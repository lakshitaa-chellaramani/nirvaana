...
export const BrainIcon = ({ className = '' }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="currentColor">
    ...
    <path d="M30 45 Q35 48 40 45" fill="none" stroke="currentColor" strokeWidth="2"/>
    <path d="M60 45 Q65 48 70 45" fill="none" stroke="currentColor" strokeWidth="2"/>
  </svg>
);
...
export const TrophyIcon = ({ className = '' }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="currentColor">
    ...
    <path d="M70 25 Q80 25 80 35 Q80 40 75 42" fill="none" stroke="currentColor" strokeWidth="2"/>
    <rect x="30" y="15" width="40" height="10" fill="currentColor"/>
  </svg>
);
...
export const PuzzleIcon = ({ className = '' }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="currentColor">
    ...
    <path d="M55 30 L70 30 L70 20 L80 20 L80 50 L70 50 L70 60 L55 60 L55 50 L45 50 L45 40 L55 40 Z"
      fill="none" stroke="currentColor" strokeWidth="3"/>
    <path d="M35 60 L35 70 L45 70 L45 80 L20 80 L20 60 Z"
      fill="none" stroke="currentColor" strokeWidth="3"/>
    <path d="M55 70 L70 70 L70 80 L80 80 L80 70 L80 60 L55 60 Z"
      fill="none" stroke="currentColor" strokeWidth="3"/>
  </svg>
);
...
export const StereoIcon = ({ className = '' }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="currentColor">
    ...
    <rect x="15" y="30" width="15" height="5" fill="currentColor"/>
    <rect x="15" y="40" width="10" height="3" fill="currentColor"/>
  </svg>
);
...
export const FilmIcon = ({ className = '' }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="currentColor">
    ...
    <rect x="15" y="27" width="5" height="5" fill="currentColor"/>
    <rect x="15" y="37" width="5" height="5" fill="currentColor"/>
    <rect x="15" y="57" width="5" height="5" fill="currentColor"/>
    <rect x="15" y="67" width="5" height="5" fill="currentColor"/>
    <rect x="80" y="27" width="5" height="5" fill="currentColor"/>
    <rect x="80" y="37" width="5" height="5" fill="currentColor"/>
    <rect x="80" y="57" width="5" height="5" fill="currentColor"/>
    <rect x="80" y="67" width="5" height="5" fill="currentColor"/>
  </svg>
);
...
export const VHSIcon = ({ className = '' }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="currentColor">
    ...
    <rect x="42" y="45" width="16" height="10" fill="currentColor" opacity="0.3"/>
    <rect x="20" y="35" width="10" height="5" fill="currentColor"/>
  </svg>
);
